...
4. Abre `tableau/bellabeat_dashboard.twbx` con [Tableau Public/Desktop](https://www.tableau.com/products/public) para explorar el dashboard interactivo.
...
*(Añade aquí tu nombre y enlace a LinkedIn/portfolio.)*
